...
class ViT(nn.Module):
    ...
    def chop_to_patches(self, x, b, c):
        ...
        chopped_x = chopped_x.reshape(b, self.image_size // self.patch_size, self.image_size // self.patch_size,
    ...
    def forward(self, x):
        ...
        # Get the total number of floating point operations
        total_flops = sum([e.flops for e in prof.key_averages()])

        # Set the self.flops attribute
